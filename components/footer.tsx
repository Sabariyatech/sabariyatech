        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <div className="flex space-x-4">
              <Link href="https://www.facebook.com/sabariyatech" target="_blank" rel="noopener noreferrer">
                <Facebook className="h-5 w-5 text-gray-400 hover:text-brand-skyblue cursor-pointer transition-colors" />
              </Link>
              <Link href="https://www.twitter.com/sabariyatech" target="_blank" rel="noopener noreferrer">
                <Twitter className="h-5 w-5 text-gray-400 hover:text-brand-skyblue cursor-pointer transition-colors" />
              </Link>
              <Link href="https://www.linkedin.com/company/sabariyatech/" target="_blank" rel="noopener noreferrer">
                <Linkedin className="h-5 w-5 text-gray-400 hover:text-brand-skyblue cursor-pointer transition-colors" />
              </Link>
              <Link href="https://www.instagram.com/sabariyatech" target="_blank" rel="noopener noreferrer">
